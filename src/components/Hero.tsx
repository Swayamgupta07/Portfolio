...
export default function Hero({ onNavigate, isDarkMode }: HeroProps) {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="mb-8">
          ...
          <p className={`text-lg max-w-2xl mx-auto mb-8 ${
            ...
            Specializing in .NET Core, Angular, and modern web technologies. 
            Building scalable solutions with a passion for innovation and user experience.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className={`px-8 py-3 font-semibold rounded-lg transition-colors shadow-lg hover:shadow-xl ${
              isDarkMode 
